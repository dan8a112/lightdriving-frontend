...
<head>
    ...
    <header>
        <div class="header_container">
            <a class="backbutton" href="">Volver</a>
        ...
        <div class="car_container">
            <section class="car_card">
                ...
                <div class="car_info_container">
                    <div class="car_info">
                        <p><span class="bold">Marca: </span><span>Toyota</span></p>
                        <p><span class="bold">Color: </span><span>Azul</span></p>
                        <p><span class="bold">Placa: </span><span>HDO-1023</span></p>
                        <p><span class="bold">Año: </span><span>2021</span></p>
                        <p><span class="bold">Desde: </span><span>2023-09-12</span></p>
                    </div>
                </div>    
            </section>
        </div>
